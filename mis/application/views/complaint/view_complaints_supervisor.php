...
?>
						<tr>
	<td><a href="<?php echo site_url("complaint/complaint_details/details/".$data_array_new[$sno][1]."/".$data_array_new[$sno][2]."/".$data_array_new[$sno][3]);?>"><?php echo $data_array_new[$sno][1];?></a></td>
							<td><?php echo $data_array_new[$sno][4];?></td>
							<td><?php echo $data_array_new[$sno][5];?></td>
							<td><?php echo $data_array_new[$sno][6];?></td>
...
?>
						<tr>
	<td><a href="<?php echo site_url("complaint/complaint_details/details/".$data_array_under_processing[$sno][1]."/".$data_array_under_processing[$sno][2]."/".$data_array_under_processing[$sno][3]);?>"><?php echo $data_array_under_processing[$sno][1];?></a></td>
...
?>
						<tr>
							<td><a href="<?php echo site_url("complaint/complaint_details/details/".$data_array_closed[$sno][1]."/".$data_array_closed[$sno][2]."/".$data_array_closed[$sno][3]);?>"><?php echo $data_array_closed[$sno][1];?></a></td>
...
?>
						<tr>
							<td><a href="<?php echo site_url("complaint/complaint_details/details/".$data_array_rejected[$sno][1]."/".$data_array_rejected[$sno][2]."/".$data_array_rejected[$sno][3]);?>"><?php echo $data_array_rejected[$sno][1];?></a></td>
...
?>
						<tr>
							<td><a href="<?php echo site_url("complaint/complaint_details/details/".$data_array_all[$sno][1]."/".$data_array_all[$sno][2]."/".$data_array_all[$sno][3]);?>"><?php echo $data_array_all[$sno][1];?></a></td>
