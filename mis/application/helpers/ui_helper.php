...
class Element {
    protected $properties = array(
					...
					'disabled'	=>	'' ,
					'extras' 	=>	'' ,
					'onkeyup'   =>  '' ,    // this is used for student admission module edit by daljeet
					'autocomplete'=>'',     // this is used for student admission module edit by daljeet
					'onchange'  => '',      // this is used for student admission module edit by daljeet
					'onClick'   =>  '');    // this is used for student admission module edit by daljeet
...
class Input extends Element {
	...
	var $uiType = '';
	var $help = '';
	var $onClick='';      // this is used for student admission module edit by daljeet
	var $onchange='';     // this is used for student admission module edit by daljeet
	var $autocomplete='';  // this is used for student admission module edit by daljeet
	var $onkeyup='';       // this is used for student admission module edit by daljeet
	var $addonRight = null;
	var $addonLeft = null;
	...
	function onClick($onClick = '')        // this function is used for student admission module edit by daljeet
	{
	   $this->properties['onClick'] = $onClick;
	   return $this;
	}
	
	function onchange($onchange = '')      // this function is used for student admission module edit by daljeet
	{
	   $this->properties['onchange'] = $onchange;
	   return $this;
	}
	
	function autocomplete($autocomplete = '')    // this function is used for student admission module edit by daljeet
	{
	   $this->properties['autocomplete'] = $autocomplete;
	   return $this;
	}
	
	function onkeyup($onkeyup = '')      // this function is used for student admission module edit by daljeet
	{
	   $this->properties['onkeyup'] = $onkeyup;
	   return $this;
	}
