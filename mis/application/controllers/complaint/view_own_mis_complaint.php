...
class View_own_mis_complaint extends MY_Controller
{
...
//		$this->addCSS("file_tracking/file_tracking_layout.css");
	...
	public function index()
	{
		...
		$res = $this->complaints->user_mis_complaint_list($user_id);
		...
		else 
		{
			...
			$this->load->view('complaint/view_own_mis_complaint',$data);
			$this->drawFooter();
		}
	}
}