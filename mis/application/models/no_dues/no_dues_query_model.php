...
//     }
 ...
 //public function check_status_2($admn_no,$sess,$dept_id){
    ...
    public function update_receipt_path_and_status_admin($receipt_path,$id,$ref,$dateof,$stu_remark){
       ...
       // $sess = $this->get_session($ts);
        ...
        if($dateof == ''){
            ...
            $data = array(
                ...
                'action_timestamp' => date('d-m-Y H:i:s'),
                'pay_timestamp' => date('d-m-Y H:i:s'),
                'previous_stu_remark' => $stu_remark,
                'previous_reject_reason' => '',
                'previous_dateofpayment' => $dateof,
                'previous_receipt_path' => $receipt_path,
                'previous_receipt_no' =>  $ref
