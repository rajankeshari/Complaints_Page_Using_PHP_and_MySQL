...
function get_stu_marks_count($sub_code,$session_year,$session,$course_id,$branch_id){
...
function get_detail_weightage($subid,$syear,$sess,$empno,$course,$branch,$sem,$section){
