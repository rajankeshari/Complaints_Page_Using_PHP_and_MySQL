...
class Student_edit extends MY_Controller
{
	...
	{
			$this->addJS('student/fetch_mtech_details_script.js');
			$data['error'] = $error;
			$this->drawHeader('Fetch M.Tech Details');
			$this->load->view('student/add/student_add_mtech_detail',$data);
			$this->drawFooter();
	}
	...
	//		}
		...
		else
		{
			...
			while($i < $n)
			{
				if(strtolower($stu_education_detail[$i]['exam']) != strtolower($stu_education_details[$i]->exam) || strtolower($stu_education_detail[$i]['branch']) != strtolower($stu_education_details[$i]->branch) || strtolower($stu_education_detail[$i]['institute']) != strtolower($stu_education_details[$i]->institute) || $stu_education_detail[$i]['year'] != $stu_education_details[$i]->year || strtolower($stu_education_detail[$i]['grade']) != strtolower($stu_education_details[$i]->grade) || strtolower($stu_education_detail[$i]['division']) != strtolower($stu_education_details[$i]->division))
				{
					$details_modified_array = array_values($details_modified_array);
					$details_modified_array[] = 'Educational Details';
					break;
