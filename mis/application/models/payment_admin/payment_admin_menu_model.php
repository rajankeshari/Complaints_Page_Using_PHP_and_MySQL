...
class Payment_admin_menu_model extends CI_Model{
    ...
    function getMenu(){
       ...
       // $menu['admin']['No Dues']['Normal No Dues']['Edit Departments'] = site_url('no_dues/no_dues_admin_edit/no_dues_dept_list');
        ...
        $menu['payment_admin']['Generate Receipt']['Enquire with Admn No.'] = site_url("payment_admin/manage_payment_complaints/enquire_with_admn_no_refund_details");
       ...
       // $menu['admin']['No Dues']['Normal No Dues']['Edit Departments'] = site_url('no_dues/no_dues_admin_edit/no_dues_dept_list');
        ...
        $menu['payment_accounts_admin']['Generate Receipt']['Enquire with Admn No.'] = site_url("payment_admin/manage_payment_complaints/enquire_with_admn_no_refund_details");
		$menu['payment_accounts_admin']['Charge Back']['Download Payment Receipt'] = site_url("payment_admin/manage_payment_complaints/download_payment_receipt");
       ...
       // $menu['admin']['No Dues']['Normal No Dues']['Edit Departments'] = site_url('no_dues/no_dues_admin_edit/no_dues_dept_list');
        ...
        $menu['payment_reports']['Change Offline Receipt'] = site_url("payment_admin/manage_payment_portal/change_offline_receipt");
        ...
        // menu for newadmission auth
        $menu['payment_admin_newadmission'] = array();
        // new admission payment
        $menu['payment_admin_newadmission']['New Admission']['Upload Full Transaction XML Report'] = site_url("payment_admin/manage_newadmission_payment/upload_complete_transaction");
        $menu['payment_admin_newadmission']['New Admission']['Upload Settlement XML Report'] = site_url("payment_admin/manage_newadmission_payment/upload_newadmission_settled_view");
        $menu['payment_admin_newadmission']['New Admission']['Check Payment Receipt'] = site_url("payment_admin/manage_newadmission_payment/payment_receipt");
        // end new admission payment
