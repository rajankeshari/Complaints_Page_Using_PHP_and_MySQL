...
class Employee_project_menu_model extends CI_Model
{
	...
	function getMenu()
	{
		...
		$menu['admin']["Project Employee"]["Edit User Details"] = site_url('employee_project/edit/index');
		...
		$menu['odean_rnd']["Project Employee"]["Edit User Details"] = site_url('employee_project/edit/index');
		...
		$menu['dean_rnd']["Project Employee"]["Edit User Details"] = site_url('employee_project/edit/index');
		...
		$menu['dean_rnd']["Institute PDF"]["Edit Institute PDF"] = site_url('employee_project/edit_pdf');
