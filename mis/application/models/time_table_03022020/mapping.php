       ...
       function insert_subject_slot_map($map_id, $subj_id, $subj_code, $ch, $ven){
        ...
        function get_mapped_slots_by_emp($session, $session_year, $empno){
         ...
         function cbcs_get_mapped_slots_by_emp($session, $session_year, $empno){
			...
			$q = $this->db->query("select distinct a.day,a.slot_no,a.venue_id,d.course_id,d.branch_id,d.semester,c.section,a.subj_code from tt_subject_slot_map_cbcs a
...
where c.emp_no='$empno' AND d.session_year='$session_year' AND d.`session`='$session' AND d.course_id='comm' and d.dept_id='comm' and d.branch_id='comm'
UNION
select distinct a.day,a.slot_no,a.venue_id,d.course_id,d.branch_id,d.semester,c.section,a.subj_code from tt_subject_slot_map_cbcs a
inner join tt_map_cbcs b on b.map_id=a.map_id
inner join cbcs_subject_offered_desc c on c.sub_id=a.subj_code
inner join cbcs_subject_offered d on d.id=c.sub_offered_id and d.session_year=b.session_year and d.session=b.session
where c.emp_no='$empno' AND d.session_year='$session_year' AND d.`session`='$session' AND d.course_id!='comm' and d.dept_id!='comm' and d.branch_id!='comm'
UNION
select distinct a.day,a.slot_no,a.venue_id,d.course_id,d.branch_id,d.semester,c.section,a.subj_code from tt_subject_slot_map_old a
...
where c.emp_no='$empno' AND d.session_year='$session_year' AND d.`session`='$session'");
