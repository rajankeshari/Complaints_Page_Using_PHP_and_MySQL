...
class Accounts_project_menu_model extends CI_Model
{
	...
	function getMenu()
	{
		...
		$menu['project_admin']['Funds Management']['Manage Interest'] = site_url('accounts_project/interest');
		...
		$menu['ar_project']['Funds Management']['Manage Interest'] = site_url('accounts_project/interest');
		...
		$menu['project_so']['Funds Management']['Manage Interest'] = site_url('accounts_project/interest');
