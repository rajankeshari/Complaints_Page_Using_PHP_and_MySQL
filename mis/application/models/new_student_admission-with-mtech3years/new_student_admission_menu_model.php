	...
	function getMenu()
	{
		...
		//jee
		  ...
		  //mtech
		      ...
		      $menu['new_adm']['Student Admission M.Tech']["Student MIS Registration"] = site_url('new_student_admission/student_register_deo_mtech');
			  $menu['new_adm']['Student Admission M.Tech']["Student MIS Registration 3 Years"] = site_url('new_student_admission/student_register_deo_mtech_3years');	 
		   
		   //mba/ex-mba
		     $menu['new_adm']['Student Admission MBA/EX-MBA']["Upload Student Database"] = site_url('new_student_admission/db_upload_mba');
		     $menu['new_adm']['Student Admission MBA/EX-MBA']["Student MIS Registration"] = site_url('new_student_admission/student_register_deo_mba');
