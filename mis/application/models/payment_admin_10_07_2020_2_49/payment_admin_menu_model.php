...
class Payment_admin_menu_model extends CI_Model{
    ...
    function getMenu(){
       ...
       // $menu['admin']['No Dues']['Normal No Dues']['Edit Departments'] = site_url('no_dues/no_dues_admin_edit/no_dues_dept_list');
        ...
        $menu['payment_academic_admin']['Upload Bank Fee Details']['Bulk Upload (Not Paid Admission Number)'] = site_url("payment_admin/manage_payment_portal/upload_late_fine_bank_fee_table");

        $menu['payment_academic_admin']['Download Bank Fee Details']['Bulk Download (Not Paid Admission Number)'] = site_url("payment_admin/manage_payment_portal/download_late_fine_bank_fee_table");

        $menu['payment_academic_admin']['View Late Fine Details']['(Not Paid Admission Number)'] = site_url("payment_admin/manage_payment_portal/late_fine_all_details");
        ...
        $menu['payment_academic_admin']['Online Offline Not Paid Payment Lists'] = site_url("payment_admin/manage_payment_portal/get_bank_fee_payment_details");
