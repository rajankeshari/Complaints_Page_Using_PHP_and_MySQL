	...
	function add_row_on_page_load()
	{
		...
		if(student_type == 'ug' || student_type == 'select')
	...
	function select_validation()
	{
		...
		if(document.getElementById('blood_group').value == 'select')
		{
			alert('Select your Blood Group');
			$('#blood_group').focus();
			return false;
		}
		if(document.getElementById('mstatus').value == 'select')
		{
		...
		if(document.getElementById('semester').value == 'select')
		{
			alert('Select your Religion');
			$('#semester').focus();
			return false;
	...
	function course_branch_validation()
	{
		...
		if(branch == "none" || course == "none" || dept == 'none')
		{
...
/*		else
	...
	function admission_based_on_validation()
	{
		...
		else if(admission_based_on == 'others')
		{
			...
			var other_rank = document.getElementById('other_rank').value;
			if(other_rank.trim() == '')
			{
				alert("Please fill the other rank.");
				$('#other_rank').focus();
				return false;
			}
			else
...
//        var tr=document.getElementById('branch_div');
	...
	function mobile_number_size_validation()
	{
		...
		if(parent_mobile_no >= 10000000000 || parent_mobile_no < 1000000000 || parent_mobile_no.length != 10)
		{
			alert("Parent mobile number not in range");
			$('#parent_mobile').focus();
			return false;
		}
		else if(present_contact_no >= 10000000000 || present_contact_no < 1000000000 || present_contact_no.length != 10)
		{
			alert("Present address mobile number not in range");
			$('#contact1').focus();
			return false;
		}
		else if(permanent_contact_no >= 10000000000 || permanent_contact_no < 1000000000 || permanent_contact_no.length != 10)
		{
			alert("Permanent address mobile number not in range");
			$('#contact2').focus();
			return false;
		}
		else if(mobile_no >= 10000000000 || mobile_no < 1000000000 || mobile_no.length != 10)
		{
	...
	function education_validation()
	{
		...
		for(i=0;i<=n_row-2;i++)
		{
			...
			{
				alert('Educational details Sno '+(i+1)+': Please fill year !!');
				$('#tableid').focus();
				return false;
			}
		}
	...
	{
		if(document.getElementById('stu_type').value == 'ug' || document.getElementById('stu_type').value == 'select')
		{
			document.getElementById('add').style.display='none';
		}
		else
