...
$(document).ready(function(){
	...
	$('#year_gap').on('change', function() {
                 	if(document.getElementById('year_gap').value == 'yes')
                        document.getElementById('cmp_year_gap').disabled=false;
					else
						document.getElementById('cmp_year_gap').disabled=true;
                });
     $('#cmp_written_technical').on('change', function() {
                 	if(document.getElementById('cmp_written_technical').value == '0' && document.getElementById('cmp_non_written_technical').value == '0')
                        document.getElementById('cmp_year_gap').disabled=true;
					else
						document.getElementById('cmp_year_gap').disabled=false;
                });
