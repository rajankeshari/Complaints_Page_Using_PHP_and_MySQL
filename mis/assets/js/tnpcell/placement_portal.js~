...
{
	$box = $("#box_block_stu_to_placement");
	$id = $("#remove_stu_id").val();
	$remarks = $("#remove_stu_remark").val();
	$blockdatetill = $("#block_date_till").val();
	$blockdatefrom = $("#block_date_from").val();
	...
	else
	{
		...
		$.ajax({
			...
			data : {
				stu_id : $id,
				remark : $remarks,
				block_date_till : $blockdatetill,
				block_date_from : $blockdatefrom
