	...
	function onclick_add()
{
	...
	function idProof_validation()
	{
		...
		else
		{
			...
			alert('The Identity Proof should be in bmp, gif, png or jpg format.');
			return false;
		}
	}
	function fetch_details()
	{
		...
		xmlhttp.open("POST",site_url("employee_project/add_pdf/check_availability_ajax/"+emp_id),true);
		xmlhttp.send();
	}
