 ...
 */
    ...
    function view(admn_no,sess, syear,dept, course_id,branch_id, sem,section, name,exam_type){
        $.ajax({            
            url: site_url('result_declaration-old-ver/result_declaration_drside/view_result'),
            type: "POST",
            async: false,
    ...
    function undo(id) {
        $.ajax({
            ...
            url: site_url('result_declaration-old-ver/result_declaration_drside/undo'),
            type: "POST",
            async: false,
            data: {"id": id},
            success: function (r) {
    ...
    function saveRe(rdec_type) {
        ...
        if ((rdec_type == 'prerd' ? $('#datere_pre').val() : $('#datere').val()) == "") {
            ...
            $.ajax({
                //result_declaration/result_declaration_drside/show_details
                url: site_url('result_declaration-old-ver/result_declaration_drside/save_re_declared'),
                type: "POST",
                async: true,
    ...
    $(document).ready(function () {
        ...
        $('#save_all').on('click', function () {
            ...
            $.ajax({
                //result_declaration/result_declaration_drside/show_details
                url:  site_url('result_declaration-old-ver/result_declaration_drside/save_admn_no_re_declared'),
                type: "POST",
                dataType: "json",
                async: false,
            ...
            $.ajax({
                url:  site_url('result_declaration-old-ver/result_declaration_drside/show_details'),
                type: "POST",
                async: false,
